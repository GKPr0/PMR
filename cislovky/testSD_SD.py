...
if __name__ == "__main__":
    test_data_root = "..\\data\\Test\\Cislovky\\SD\\p2206"

    model_root = "SD_Experiment"
    model_iteration = 20
    reference_mlf_file = "SD_reference.mlf"
    result_mlf_file = "SD_SD_results.mlf"
    result_file = "SD_on_SD_results.txt"
